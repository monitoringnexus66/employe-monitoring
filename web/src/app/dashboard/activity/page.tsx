          ...
          <table className="w-full text-left border-collapse table-fixed">
            <thead>
              <tr className="border-b border-white/10 bg-white/5">
                <th className="p-4 font-medium text-muted-foreground text-sm w-40 sm:w-48">Timestamp</th>
                <th className="p-4 font-medium text-muted-foreground text-sm w-32 sm:w-40">Employee</th>
                <th className="p-4 font-medium text-muted-foreground text-sm w-32 sm:w-48">Application</th>
            ...
            <tbody className="divide-y divide-white/5">
              {logs.map((log) => (
                <tr key={log.id} className="hover:bg-white/5 transition-colors">
                  ...
                  <td className="p-4 text-sm text-blue-400 truncate">{log.appName}</td>
                  <td className="p-4 text-sm text-gray-400 truncate">{log.windowTitle}</td>

    ...
    <div className="space-y-8 animate-in fade-in duration-500 max-w-3xl">
      ...
      <div className="glass-card rounded-xl p-8 border border-white/5">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <a href="https://github.com/monitoringnexus66/employe-monitoring/releases/download/app-v0.1.2/chiiOs.Agent_0.1.2_universal.dmg" target="_blank" rel="noopener noreferrer" className="block">
          ...
          <a href="https://github.com/monitoringnexus66/employe-monitoring/releases/download/app-v0.1.2/chiiOs.Agent_0.1.2_x64-setup.exe" target="_blank" rel="noopener noreferrer" className="block">
            <div className="h-full flex flex-col items-center justify-center p-6 rounded-xl bg-secondary/50 hover:bg-secondary border border-white/10 transition-colors cursor-pointer group text-center gap-3">
